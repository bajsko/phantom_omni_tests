...
//cube 1 rot
voxelengine::Vector3 PhantomOMNIScene_1_h_1_cube::cube1rot = voxelengine::Vector3(0, 0, 0);
//Is bbtn 1 pressed on ANY device?
bool PhantomOMNIScene_1_h_1_cube::bBtn1Down = false;

voxelengine::Vector3 PhantomOMNIScene_1_h_1_cube::amountOfRot;

bool PhantomOMNIScene_1_h_1_cube::rotateCube = false;

//stores first touch position (touches the cube)
voxelengine::Vector3 PhantomOMNIScene_1_h_1_cube::touchPos = voxelengine::Vector3(0, 0, 0);
//stores release position
voxelengine::Vector3 PhantomOMNIScene_1_h_1_cube::releasePos = voxelengine::Vector3(0, 0, 0);

/*///////////////////////////////////////////////////////////////////////////////////////////////////////////////
PhantomOMNIScene_1_h_1_cube::touchShapeCallback(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
...
*////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HLCALLBACK PhantomOMNIScene_1_h_1_cube::touchShapeCallback(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
{
	printf("Touched shape with ID %d\n", object);
}

/*///////////////////////////////////////////////////////////////////////////////////////////////////////////////
PhantomOMNIScene_1_h_1_cube::untouchShapeCallback(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
...
*////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HLCALLBACK PhantomOMNIScene_1_h_1_cube::untouchShapeCallback(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
{
	printf("Uouched shape with ID %d\n", object);
}

/*///////////////////////////////////////////////////////////////////////////////////////////////////////////////
PhantomOMNIScene_1_h_1_cube::touchCubeCallback(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
...
*////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HLCALLBACK PhantomOMNIScene_1_h_1_cube::touchCubeCallback(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
{
...
/*///////////////////////////////////////////////////////////////////////////////////////////////////////////////
PhantomOMNIScene_1_h_1_cube::untouchCubeCallback(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
...
*////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HLCALLBACK PhantomOMNIScene_1_h_1_cube::untouchCubeCallback(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
{
...
*////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HLCALLBACK PhantomOMNIScene_1_h_1_cube::button1down(HLenum event, HLuint object, HLenum thread, HLcache *cache, void *userdata)
{
...
*////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HLCALLBACK PhantomOMNIScene_1_h_1_cube::button1up(HLenum event, HLuint object, HLenum thread, HLcache *cache, void *userdata)
{
	printf("Bacon 1 up\n");
	bBtn1Down = !bBtn1Down;
}
...
/*///////////////////////////////////////////////////////////////////////////////////////////////////////////////
PhantomOMNIScene_1_h_1_cube::button1downoncube(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
...
*////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HLCALLBACK PhantomOMNIScene_1_h_1_cube::button1downoncube(HLenum event, HLuint object, HLenum thread, HLcache *cache, void *userdata)
{
	printf("Button 1 down on CUBE\n");
}

/*///////////////////////////////////////////////////////////////////////////////////////////////////////////////
PhantomOMNIScene_1_h_1_cube::button1uponcube(HLenum event, HLuint object, HLenum thread, HLcache *cache, void* userdata)
...
*////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HLCALLBACK PhantomOMNIScene_1_h_1_cube::button1uponcube(HLenum event, HLuint object, HLenum thread, HLcache *cache, void *userdata)
{
	printf("Btton 1 up on CUBE\n");
}

PhantomOMNIScene_1_h_1_cube::PhantomOMNIScene_1_h_1_cube(OpenGLRenderer *renderer) : Scene(renderer)
{
...
*////////////////////////////////////////////////////////////////////////////////
void PhantomOMNIScene_1_h_1_cube::updateWorkspace()
{
...
void PhantomOMNIScene_1_h_1_cube::resize(int w, int h)
{
...
PhantomOMNIScene_1_h_1_cube::~PhantomOMNIScene_1_h_1_cube()
{
}

void PhantomOMNIScene_1_h_1_cube::initGL()
{
...
void PhantomOMNIScene_1_h_1_cube::initHD(HDstring pConfigName, HHD &ghHD)
{
	HDErrorInfo error;
...
void PhantomOMNIScene_1_h_1_cube::initHL(HHD hHD, HHLRC &hHLRC)
{
	...
	{
		hlAddEventCallback(HL_EVENT_1BUTTONDOWN, faces[i].ID, HL_CLIENT_THREAD, &button1downoncube, NULL);
		hlAddEventCallback(HL_EVENT_1BUTTONUP, faces[i].ID, HL_CLIENT_THREAD, &button1uponcube, NULL);
		hlAddEventCallback(HL_EVENT_TOUCH, faces[i].ID, HL_CLIENT_THREAD, &touchCubeCallback, NULL);
		hlAddEventCallback(HL_EVENT_UNTOUCH, faces[i].ID, HL_CLIENT_THREAD, &untouchCubeCallback, NULL);
	}
}

void PhantomOMNIScene_1_h_1_cube::createFaces()
{
	float halfSize = 0.5f;
	Face face;

	//face1
	face.ID = hlGenShapes(1);
	face.displayList = glGenLists(1);

	glNewList(face.displayList, GL_COMPILE);
	m_renderer->BeginImmediateMode(IM_QUADS);
	m_renderer->ImmediateVertex(-halfSize, -halfSize, halfSize);
	m_renderer->ImmediateVertex(halfSize, -halfSize, halfSize);
	m_renderer->ImmediateVertex(halfSize, halfSize, halfSize);
	m_renderer->ImmediateVertex(-halfSize, halfSize, halfSize);
	m_renderer->EndImmediateMode();
	glEndList();
...
/*////////////////////////////////////////////////////////////////////////////
PhantomOMNIScene_1_h_1_cube::Update(float dt)
...
*//////////////////////////////////////////////////////////////////////////////
void PhantomOMNIScene_1_h_1_cube::Update(float dt)
{
...
/*/////////////////////////////////////////////////////////////////////
PhantomOMNIScene_1_h_1_cube::drawCursor(Vector3 color)
...
*/////////////////////////////////////////////////////////////////////
void PhantomOMNIScene_1_h_1_cube::drawCursor(voxelengine::Vector3 color)
{
...
*///////////////////////////////////////
void PhantomOMNIScene_1_h_1_cube::drawSceneHaptics(HLuint shapeid)
{
	hlBeginFrame();
...
void PhantomOMNIScene_1_h_1_cube::Render()
{
	...
	for (int i = 0; i < faces.size(); i++)
	{
		...
		glPushMatrix();
		hlBeginShape(HL_SHAPE_FEEDBACK_BUFFER, faces[i].ID);
		glRotatef(cube1rot.x, 0, 1, 0);
		glRotatef(cube1rot.y, 1, 0, 0);
		glRotatef(cube1rot.z, 0, 0, 1);
		//glRotatef(45, 0, 1, 0);
		glCallList(faces[i].displayList);
		glPopMatrix();
...
void PhantomOMNIScene_1_h_1_cube::free()
{
